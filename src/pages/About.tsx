  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-background text-foreground">
        <Navbar />
        <section className="pt-36 pb-[120px] px-8 md:px-16">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-serif font-medium leading-[1.08] tracking-tight text-foreground mb-16">
              Why Rubiklab exists
            </h1>
            ...
            <div className="max-w-[55ch] space-y-6">
      ...
      <div className="theme-light bg-background text-foreground">
        ...
        <section className="pt-[120px] pb-[80px] px-8 md:px-16">
          <div className="max-w-4xl">
            <h2 className="text-3xl md:text-5xl lg:text-[3.5rem] font-serif font-medium leading-[1.12] tracking-[-0.01em] text-foreground mb-16">
        ...
        {/* 2B — What We Built */}
        <section className="pb-[80px] px-8 md:px-16">
          <div className="max-w-4xl">
            <h2 className="text-4xl md:text-6xl lg:text-[4rem] font-serif font-medium leading-[1.1] tracking-[-0.01em] text-foreground mb-16 mt-8">
              Infrastructure<br />
              before automation
            </h2>
        ...
        <section className="pb-[80px] px-8 md:px-16">
          <div className="max-w-5xl">
            <h2 className="text-3xl md:text-5xl font-serif font-medium leading-[1.12] tracking-[-0.01em] text-foreground mb-16">
              How Rubiklab works
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-14 md:gap-12">
              {[
        ...
        {/* 2D — Our Principles */}
        <section className="pb-[120px] px-8 md:px-16">
          <div className="max-w-4xl">
            <h2 className="text-3xl md:text-5xl font-serif font-medium leading-[1.12] tracking-[-0.01em] text-foreground mb-20">
              Our principles
            </h2>
      ...
      <div className="bg-background text-foreground">
        <section className="py-[120px] px-8 md:px-16">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-secondary-foreground leading-relaxed mb-16 max-w-[50ch]">
      ...
      <div className="theme-light bg-background text-foreground">
        <section className="py-[120px] px-8 md:px-16">
          <div className="max-w-4xl">
            <h2 className="text-4xl md:text-6xl lg:text-[4rem] font-serif font-medium leading-[1.1] tracking-[-0.01em] text-foreground mb-16">
              The future requires structure
            </h2>
            <div className="max-w-[55ch] space-y-6 mb-16">
              <p className="text-base text-muted-foreground leading-relaxed">
