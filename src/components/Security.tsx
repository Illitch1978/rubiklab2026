  ...
  return (
    <section className="py-[140px] px-8 md:px-16">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-muted-foreground text-base md:text-lg max-w-[680px] leading-relaxed mb-8">
        ...
        <ul className="text-muted-foreground text-base md:text-lg max-w-[680px] space-y-4 list-none">
        ...
        <p className="text-foreground text-base md:text-lg max-w-[680px] font-medium leading-relaxed mt-10">
