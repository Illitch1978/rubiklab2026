...
const PlatformHero = () => {
  ...
  return (
    <section className="h-screen flex flex-col px-8 md:px-16 overflow-hidden">
      {/* Text — top-left, matching other hero pages */}
      <div className="pt-32 pb-10 max-w-3xl">
        <h1 className="text-5xl md:text-7xl lg:text-[6.5rem] font-serif font-medium leading-[0.95] mb-6 text-foreground tracking-tight">
          Intelligence<br />Studio<span
      ...
      {/* Carousel — fills remaining viewport height */}
      <div className="flex-1 min-h-0 pb-8">
        <div className="relative w-full h-full rounded-xl overflow-hidden border border-foreground/10 shadow-2xl">
          {slides.map((slide, i) => (
            <div
              key={i}
